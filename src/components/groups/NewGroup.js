...
class NewGroup extends Component {
    ...
    newGroup(e) {
        ...
        newGroup.append("imagesGroup", this.state.sendFile);
                ...
                <div className={this.state.active + ' w-100 colum bg-danger position-absolute'}>
                    <div className="row">
                        <div className="col-md-12">
                            ...
                            <center>
                                <img salve={process.env.REACT_APP_API_URL} src={this.state.file} width="200" className="img-fluid img-circle mt-3 img-newGroup" alt="logo" />
                            </center>
